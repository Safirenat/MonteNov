	...
	return (
		<div className="App">
				...
				<div>
					...
					avoids a pain that produces no resultant pleasure?" Абзац
					1.10.33 "de Finibus Bonorum "But I must explain to you how
					...
					produces no resultant pleasure?" Абзац 1.10.33 "de Finibus
					Bonorum "But I must explain to you how all this mistaken
					idea of denouncing pleasure and praising pain was born and I
					will give you a complete account of the system, and expound
					the actual teachings of the great explorer of the truth, the
					master-builder of human happiness. No one rejects, dislikes,
